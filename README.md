...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-autoplotly-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-autoplotly-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-autoplotly
# for installing globally
pixi global install r-autoplotly
```
...
It is possible to list all of the versions of `r-autoplotly` available on your platform:
...
```
pixi search r-autoplotly --channel conda-forge
```
